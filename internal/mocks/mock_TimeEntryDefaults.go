...
type mockConstructorTestingTNewMockTimeEntryDefaults interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockTimeEntryDefaults(t mockConstructorTestingTNewMockTimeEntryDefaults) *MockTimeEntryDefaults {
